...
// ----- Elemento tabla de usuarios ------
const usersTable = document.getElementById('usersTable');
// ----- Elemento form editar usuario ------
...
// Variable global para guardar id de usuario en edición.
let editUserId = '';
// ----- Elementos de búsqueda ------
const searchForm = document.getElementById('searchForm');
const searchInput = document.getElementById('search');

// Función que busca y devuelve los usuarios de localStorage
const getStorageUsers = () => JSON.parse(localStorage.getItem('users')) || [];


const generateId = function () {
    // Esta función genera y devuelve un id único y aleatorio.
...
const getModal = (user) => {
    ...
    return `
            ...
            <!-- Modal mostrar datos de usuario -->
